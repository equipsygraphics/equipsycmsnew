...
export const pendingRequests = [
  { type: 'Quote', count: 5 },
  { type: 'Trade Account', count: 3 },
  { type: 'Builder Pack', count: 2 },
]

export const quickActions = [
  { label: 'Add Product', icon: 'plus', to: '/products/new' },
  { label: 'New Blog Post', icon: 'edit', to: '/blog/new' },
  { label: 'Process Orders', icon: 'package', to: '/orders' },
  { label: 'View Requests', icon: 'inbox', to: '/quote-requests' },
]
...
export const WIDGET_CATALOG = [
  { id: 'kpi',          label: 'KPI Metrics',         size: 'full' },
  { id: 'customer',     label: 'Customer Breakdown',  size: 'third' },
  { id: 'vendor',       label: 'Vendor Rating',       size: 'two-thirds' },
  { id: 'revenue',      label: 'Revenue Summary',     size: 'full' },
  { id: 'recent_orders',label: 'Recent Orders',       size: 'half' },
  { id: 'low_stock',    label: 'Low Stock Alerts',    size: 'half' },
  { id: 'traffic',      label: 'Traffic Summary',     size: 'half' },
  { id: 'requests',     label: 'Pending Requests',    size: 'half' },
]
