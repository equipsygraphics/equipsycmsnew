...
export const mockBuilderPacks = [
  { id: 'BP-021', firstName: 'Dave', lastName: 'Nguyen', company: 'Landmark Constructions', occupation: 'Builder', email: 'dave@landmark.com.au', phone: '(03) 9876 5432', deliveryAddress: '12 Industry Ave, Dandenong VIC 3175', projectType: 'SDA Dwelling', units: 12, state: 'VIC', status: 'shipped', shippitBookedAt: '21 Jun 2026, 10:32 AM', requested: '20 Jun 2026', notes: 'Large SDA project in Dandenong.' },
  { id: 'BP-020', firstName: 'Karen', lastName: 'Smith', company: 'BluePrint Builders', occupation: 'Builder', email: 'karen@blueprint.com.au', phone: '(02) 8765 4321', deliveryAddress: '55 Commerce Rd, Artarmon NSW 2064', projectType: 'Aged Care Facility', units: 40, state: 'NSW', status: 'shipped', shippitBookedAt: '19 Jun 2026, 2:15 PM', requested: '18 Jun 2026', notes: '' },
  { id: 'BP-019', firstName: 'Jim', lastName: 'West', company: 'HomeAccess Pty Ltd', occupation: 'OT', email: 'jim@homeaccess.com.au', phone: '0411 222 333', deliveryAddress: '8 Riverside Dr, Fortitude Valley QLD 4006', projectType: 'Residential Modifications', units: 3, state: 'QLD', status: 'pending', shippitBookedAt: null, requested: '22 Jun 2026', notes: 'First-time builder pack request.' },
  { id: 'BP-018', firstName: 'Amy', lastName: 'Tan', company: 'Precision Build Co.', occupation: 'Builder', email: 'amy@precisionbuild.com.au', phone: '(08) 9234 5678', deliveryAddress: '33 Kewdale Rd, Kewdale WA 6105', projectType: 'SDA Dwelling', units: 6, state: 'WA', status: 'pending', shippitBookedAt: null, requested: '23 Jun 2026', notes: '' },
]
